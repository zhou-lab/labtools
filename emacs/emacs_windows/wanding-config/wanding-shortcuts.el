...
;; f2 is menu
;; f3-f4 is macro
(global-set-key (kbd "<scroll>") 'goto-line)
...
;; (global-set-key (kbd "<home>") 'helm-recentf)
;; (global-set-key (kbd "<f9>") 'find-file)
;; (global-set-key (kbd "<Super>") 'find-file) ;; the Windows key
...
;; (global-set-key (kbd "<insert>") 'kill-ring-save)
(global-set-key (kbd "<Scroll_Lock>") 'set-mark-command)
(global-set-key [mouse-4] 'delete-forward-char)
(global-set-key [mouse-5] 'mouse-yank-primary)
